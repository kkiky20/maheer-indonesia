...
const ShapeGrid = ({
  ...
  useEffect(() => {
    ...
    // Pastikan tidak block klik tombol di atasnya
    ...
    const drawGrid = () => {
      ...
      // Background gradient digambar PERTAMA agar tidak menutupi grid dan hover trail
      ...
      gradient.addColorStop(1, 'rgba(245, 243, 255, 0.5)');
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      // Calculate mouse position relative to canvas, but take it from window event
    ...
    // Intersection Observer untuk menghentikan animasi saat out-of-view
    ...
    if (isVisible.current && !requestRef.current) {
      requestRef.current = requestAnimationFrame(updateAnimation);
    }
