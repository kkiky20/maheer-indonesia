...
const CanvasWrapper = ({ children }: any) => (
  <Canvas dpr={[1, 2]} frameloop="always" className="w-full h-full relative" style={{ pointerEvents: 'none' }}>
    {children}
  </Canvas>
);
...
const Beams = ({
  ...
  scale = 0.2,
  rotation = 0,
  baseColor = '#D8B4E2', // default to light lavender beams
  bgColor = '#ffffff' // default background to white
}: any) => {
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
        ...
        material: { fog: true },
        uniforms: {
          diffuse: new THREE.Color(...hexToNormalizedRGB(baseColor)), // modified to use baseColor
